...
contact-file=/home/coiniclesnet/1/self.signed
# path to store transport private key
transport-privkey=/home/coiniclesnet/1/transport.private
# path to store identity signing key
ident-privkey=/home/coiniclesnet/1/identity.private
# encryption key for onion routing
encryption-privkey=/home/coiniclesnet/1/encryption.private
...
user=coiniclesnet
group=coiniclesnet
pidfile=/home/coiniclesnet/1/coiniclesnet.pid
...
add-node=/home/coiniclesnet/1/bootstrap.signed

# snapps configuration section
[services]# uncomment next line to enable a snapp
#example-snapp=/home/coiniclesnet/1/snapp-example.ini
...
ifaddr=10.101.0.1/16
  ...
  ASSERT_THAT(config.bootstrap.routers,
              ElementsAre("/home/coiniclesnet/1/bootstrap.signed"));
}
