...
def exit_sessions_main():
    if len(sys.argv) == 2 and sys.argv[1] == 'config':
        print("graph_title coiniclesnet exit sessions")
        print("graph_vlabel sessions")
        print("graph_category network")
        print("graph_info This graph shows the number of exit sessions on a coiniclesnet exit")
...
def peers_main():
    if len(sys.argv) == 2 and sys.argv[1] == 'config':
        ...
        print("graph_category network")
        print("graph_info This graph shows the number of node to node sessions of this coiniclesnet router")
...
if __name__ == '__main__':
    ...
    if exe == 'coiniclesnet_peers':
        peers_main()
    elif exe == 'coiniclesnet_exit':
        exit_sessions_main()
    else:
        print(
            'please symlink this as `coiniclesnet_peers` or `coiniclesnet_exit` in munin plugins dir')
