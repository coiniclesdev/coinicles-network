...
libpath = 'libshadow-plugin-coiniclesnet.so'
...
if __name__ == '__main__':
    settings = {
        'baseDir': os.path.join("/tmp", "coiniclesnet-shadow"),
