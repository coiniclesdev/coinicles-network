...
startWinsock()
{
  ...
  ::CreateMutex(nullptr, FALSE, "coiniclesnet_win32_daemon");
  return 0;
}
...
main(int argc, char *argv[])
{
  ...
  cxxopts::Options options("coiniclesnet",
  ...
  do
  {
    // do periodic non coiniclesnet related tasks here
    if(ctx != nullptr)
    {
