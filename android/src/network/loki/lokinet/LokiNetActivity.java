...
public class CoiniclesNetActivity extends Activity {
	private static final String TAG = "coiniclesnet-activity";
	private TextView textView;
	private static final String DefaultBootstrapURL = "https://seed.coiniclesnet.org/bootstrap.signed";
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		System.loadLibrary("coiniclesnetandroid");
	}
	...
	public void runCoiniclesnetService()
	{
		startService(new Intent(CoiniclesNetActivity.this,
				CoiniclesnetService.class));
	}
