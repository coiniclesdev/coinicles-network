...
// Copied from coinicles-mq (with namespaces modified); when we fully import coinicles-mq
// we can just use it directly.

// To keep this identical to coinicles-mq's copy (e.g. to be able to diff it):
//
// clang-format off
