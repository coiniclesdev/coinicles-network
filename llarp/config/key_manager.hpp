...
namespace llarp
{
  ...
  struct KeyManager
  {
   ...
   private:
    ...
    bool m_usingCoiniclesd          = false;
    std::string m_coiniclesdRPCAddr = "127.0.0.1:32023";
    std::string m_coiniclesdRPCUser;
    std::string m_coiniclesdRPCPassword;
    ...
    /// Requests the identity key from coiniclesd via HTTP (curl)
    bool
    loadIdentityFromCoiniclesd();
  };
