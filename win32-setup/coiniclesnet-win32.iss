...
#define MyAppName "Coiniclesnet"
#define MyAppVersion "0.7.0"
#define MyAppPublisher "Coinicles Project"
#define MyAppURL "https://coiniclesnet.tech"
#define MyAppExeName "coiniclesui.exe"
...
OutputBaseFilename=coiniclesnet-win32
Compression=lzma2/ultra64
SolidCompression=yes
VersionInfoVersion=0.7.0
VersionInfoCompany=Coinicles Project
VersionInfoDescription=Coiniclesnet for Microsoft� Windows� NT�
#ifndef RELEASE
...
#endif
VersionInfoProductName=Coiniclesnet
VersionInfoProductVersion=0.7.0
InternalCompressLevel=ultra64
MinVersion=0,5.0
ArchitecturesInstallIn64BitMode=x64
VersionInfoCopyright=Copyright �2018-2020 Coinicles Project
AppMutex=coiniclesnet_win32_daemon,coiniclesnet_qt5_ui,coiniclesnet_dotnet_ui
...
#ifdef SINGLE_ARCH
Source: "{#DevPath}build\coiniclesnet.exe"; DestDir: "{app}"; Flags: ignoreversion
; don't ship it, we don't have a public api yet!
;Source: "{#DevPath}build\libcoiniclesnet-shared.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "dbghelp64.dll"; DestName: "dbghelp.dll"; DestDir: "{app}"; Flags: ignoreversion
#else
Source: "{#DevPath}build\coiniclesnet.exe"; DestDir: "{app}"; Flags: ignoreversion 32bit; Check: not IsWin64
;Source: "{#DevPath}build\libcoiniclesnet-shared.dll"; DestDir: "{app}"; Flags: ignoreversion 32bit; Check: not IsWin64
Source: "dbghelp32.dll"; DestName: "dbghelp.dll"; DestDir: "{app}"; Flags: ignoreversion; Check: not IsWin64
Source: "{#DevPath}build64\coiniclesnet.exe"; DestDir: "{app}"; Flags: ignoreversion 64bit; Check: IsWin64
;Source: "{#DevPath}build64\libcoiniclesnet-shared.dll"; DestDir: "{app}"; Flags: ignoreversion 64bit; Check: IsWin64
Source: "dbghelp64.dll"; DestDir: "{app}"; DestName: "dbghelp.dll"; Flags: ignoreversion; Check: IsWin64
#endif
; UI has landed!
#ifndef RELEASE
Source: "{#DevPath}ui-win32\bin\debug\coiniclesnetui.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "{#DevPath}ui-win32\bin\debug\coiniclesnetui.exe.config"; DestDir: "{app}"; Flags: ignoreversion
Source: "{#DevPath}ui-win32\bin\debug\coiniclesnetui.pdb"; DestDir: "{app}"; Flags: ignoreversion
#else
Source: "{#DevPath}ui-win32\bin\release\coiniclesnetui.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "{#DevPath}ui-win32\bin\release\coiniclesnetui.exe.config"; DestDir: "{app}"; Flags: ignoreversion
Source: "{#DevPath}ui-win32\bin\release\coiniclesnetui.pdb"; DestDir: "{app}"; Flags: ignoreversion
#endif
...
Source: "{#DevPath}build\coiniclesnetctl.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "LICENSE"; DestDir: "{app}"; Flags: ignoreversion
Source: "coiniclesnet-bootstrap.exe"; DestDir: "{app}"; Flags: ignoreversion
...
Source: "coiniclesnet-qt5-ui.7z"; DestDir: "{app}"; Flags: ignoreversion deleteafterinstall; MinVersion: 0,6.0;
Source: "coiniclesnet.ico"; DestDir: "{app}"; Flags: ignoreversion;
...
Source: "config_migration.bat"; DestDir: "{userappdata}\.coiniclesnet"; Flags: deleteafterinstall; MinVersion: 0,6.0
...
Type: filesandordirs; Name: "{app}\coiniclesnet-qt5-ui"; MinVersion: 0,6.0
Type: filesandordirs; Name: "{userappdata}\.coiniclesnet"
...
begin
  ...
  if IsTaskSelected('migrateconfigs') then
    MsgBox('Coiniclesnet JSON-RPC API endpoint enabled. Any custom configuration was retained in %APPDATA%\.coiniclesnet\coiniclesnet.old.ini.', mbInformation, MB_OK);
  end;
end;
...
[Icons]
Name: "{group}\{#MyAppName}"; Filename: "{app}\{#MyAppExeName}"; OnlyBelowVersion: 0, 6.0; IconFilename: "{app}\coiniclesnet.ico"
Name: "{group}\{#MyAppName}"; Filename: "{app}\coiniclesnet-qt5-ui\coiniclesnetui.exe"; MinVersion: 0, 6.0; IconFilename: "{app}\coiniclesnet.ico"
Name: "{group}\{cm:ProgramOnTheWeb,{#MyAppName}}"; Filename: "{#MyAppURL}"
Name: "{group}\{cm:UninstallProgram,{#MyAppName}}"; Filename: "{uninstallexe}"
Name: "{commondesktop}\{#MyAppName}"; Filename: "{app}\{#MyAppExeName}"; Tasks: desktopicon; OnlyBelowVersion: 0,6.0; IconFilename: "{app}\coiniclesnet.ico"
Name: "{commondesktop}\{#MyAppName}"; Filename: "{app}\coiniclesnet-qt5-ui\coiniclesnetui.exe"; Tasks: desktopicon; MinVersion: 0,6.0; IconFilename: "{app}\coiniclesnet.ico"
Name: "{userappdata}\Microsoft\Internet Explorer\Quick Launch\{#MyAppName}"; Filename: "{app}\{#MyAppExeName}"; Tasks: quicklaunchicon; OnlyBelowVersion: 0, 6.1; IconFilename: "{app}\coiniclesnet.ico"
Name: "{userappdata}\Microsoft\Internet Explorer\Quick Launch\User Pinned\TaskBar\{#MyAppName}"; Filename: "{app}\coiniclesnet-qt5-ui\coiniclesnetui.exe"; Tasks: quicklaunchicon; MinVersion: 0, 6.1; IconFilename: "{app}\coiniclesnet.ico"
...
Filename: "{app}\coiniclesnet-qt5-ui\coiniclesnetui.exe"; Flags: nowait postinstall skipifsilent; Description: "{cm:LaunchProgram,{#StringChange(MyAppName, '&', '&&')}}"; MinVersion: 0,6.0
...
Filename: "{tmp}\7z.exe"; Parameters: "x coiniclesnet-qt5-ui.7z -aoa"; WorkingDir: "{app}"; Flags: runascurrentuser waituntilterminated skipifdoesntexist; Description: "installing modern Qt5 UI"; StatusMsg: "Installing modern Qt5 UI..."; MinVersion: 0, 6.0;
Filename: "{app}\coiniclesnet-bootstrap.exe"; Parameters:"-L https://seeds.coinicles.tech/coiniclesnet.signed --cacert rootcerts.pem -o ""{userappdata}\.coiniclesnet\bootstrap.signed"""; WorkingDir: "{app}"; Flags: runascurrentuser waituntilterminated; Description: "bootstrap dht"; StatusMsg: "Downloading initial RC..."
...
Filename: "{userappdata}\.coiniclesnet\config_migration.bat"; WorkingDir: "{userappdata}\.coiniclesnet"; Flags: runascurrentuser waituntilterminated; Description: "migrate existing config"; StatusMsg: "Migrating old configuration..."; MinVersion: 0,6.0; Tasks: migrateconfigs;